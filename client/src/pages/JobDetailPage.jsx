...
export default function JobDetailPage() {
  ...
  if (!job) {
    return <p className="mx-auto max-w-6xl px-4 py-16 text-center text-sm text-slate-400">Loading role…</p>;
  }
    ...
    <section className="mx-auto max-w-6xl px-4 py-10">
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-3">
        <div className="rounded-xl border border-white/10 bg-surface p-6 lg:col-span-2">
          ...
          <p className="mt-2 text-sm text-slate-400">{job.description || 'No description yet.'}</p>
