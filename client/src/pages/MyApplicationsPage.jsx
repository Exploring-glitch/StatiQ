...
const STAGE = { applied: 'text-slate-300', reviewing: 'text-yellow-400', interview: 'text-accent', offer: 'text-emerald-400', rejected: 'text-red-400' };
  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-10">
      ...
      <div className="mt-6 space-y-3">
        {items.map((a) => (
          <div key={a._id} className="flex items-center justify-between rounded-xl border border-white/10 bg-surface p-4">
            <div>
