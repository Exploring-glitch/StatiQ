    ...
    <section id="cta" className="mx-auto max-w-6xl px-4 pb-14">
      <div className="rounded-2xl border border-white/10 bg-surface p-10 text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <a href="#" className="rounded-md bg-accent px-5 py-2.5 text-sm font-semibold text-base hover:bg-accentHover">
            Sign up to find a job →
          </a>
          <a href="#companies" className="rounded-md bg-white px-5 py-2.5 text-sm font-semibold text-base hover:bg-slate-200">
            Start hiring
          </a>
        </div>
      </div>
